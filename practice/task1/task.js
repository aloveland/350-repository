...
//
const query1 = "SELECT mlength, title FROM movies where (mlength < 100) ORDER BY mlength ASC";
//
...
//      Animation   |           968.5
//      Action      |         3853.27
const query3 = "SELECT genre as genre, SUM(boxoffice) as total_boxoffice FROM movies GROUP BY genre order by SUM(boxoffice) ASC";
//
// query 4: print out the title and boxoffice of the movie with the highest boxoffice.
//
const query4 = "SELECT genre as genre, SUM(boxoffice) as total_boxoffice FROM movies GROUP BY genre order by SUM(boxoffice) DESC LIMIT 1";
