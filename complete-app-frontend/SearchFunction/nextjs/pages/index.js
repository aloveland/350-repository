  ...
  render() {
    ...
    return (
      ...
      >	
        ...
        <h2>Find the best way to reconnect with nature and take a break from the hectic life in the city. Use our database of campgrounds to find the best site for you! Navigate to our search page or the about page to find more information.</h2>
